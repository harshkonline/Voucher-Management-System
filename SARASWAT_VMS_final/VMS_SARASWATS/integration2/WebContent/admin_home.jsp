...
<table class="menu" width="100%" style=" border-collapse: collapse;"  >
	<tr>
		<td align="left"><a href="<s:url action="adminhome" />">Home</a></td>
		<td align="right"><a href="<s:url action="logout" />">Logout</a></td>
	</tr>
</table>

<jsp:include page="option1_include.jsp"></jsp:include>

<h2 align="center">Welcome <s:property value="#session.username"/> </h2>
</body>
</html>